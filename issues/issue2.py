...
# a)
student_gender_is_female_counter = sum(student["gender"] == "female" for student in DATA)

probability_of_student_gender_is_female = student_gender_is_female_counter / len(DATA)
